...
df = read.csv("https://raw.githubusercontent.com/WXYS1209/STAT436/main/2021-2022%20Football%20Player%20Stats.csv",
              sep=";")
dff = read.csv("https://raw.githubusercontent.com/WXYS1209/STAT436/main/st.txt",
               header = T)
...
km14 = kmeans(x_scores[,1:15], centers = 4, iter.max = 100, algorithm = "MacQueen", nstart = 4)
...
ui <- fluidPage(
  ...
  helpText("PCA and kNN model are used to obtain the classification."),
  sidebarLayout(
    sidebarPanel(
